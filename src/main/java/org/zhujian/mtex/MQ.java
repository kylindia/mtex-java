...
public class MQ {
    ...
    public static void connect() throws MQException {
        MQEnvironment.hostname = "192.168.1.110";
        MQEnvironment.channel = "SERVERCONN";//"QM_ORANGE.QM_APPLE"; //是额外创建服务器连接channel!!
        MQEnvironment.port = 1414;
        MQEnvironment.CCSID = CCSID;
        //MQ中拥有权限的用户名
        MQEnvironment.userID = "fmy";//MUSR_MQADMIN 需要保证在mqm用户组中
        //用户名对应的密码
        MQEnvironment.password = "123456";

        qMgr = new MQQueueManager("QM_APPLE");
